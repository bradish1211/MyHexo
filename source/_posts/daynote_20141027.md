...
![ECharts Architecture](https://github.com/ecomfe/echarts/blob/master/doc/asset/img/architecture.png)
...
![ECharts 混搭](https://github.com/ecomfe/echarts/blob/master/doc/asset/img/mix.jpg)

### 拖拽重计算
拖拽重计算特性（专利）带来了数据统计图表从未有过的用户体验，允许用户对统计数据进行有效的提取、整合，甚至在多个图表间交换数据，赋予了用户对数据进行挖掘、整合的能力。

![ECharts 拖拽重计算](https://github.com/ecomfe/echarts/blob/master/doc/asset/img/draggable.gif)
...
![ECharts 数据视图](https://github.com/ecomfe/echarts/blob/master/doc/asset/img/dataView.gif)
...
![ECharts 动态类型切换](https://github.com/ecomfe/echarts/blob/master/doc/asset/img/magicType.gif)
...
![ECharts 图例开关](https://github.com/ecomfe/echarts/blob/master/doc/asset/img/legendSelected.gif)
...
![ECharts 数据区域选择](https://github.com/ecomfe/echarts/blob/master/doc/asset/img/datazoom.gif)
...
![ECharts 数据区域选择](https://github.com/ecomfe/echarts/blob/master/doc/asset/img/connect.gif)
...
![ECharts 数据区域选择](https://github.com/ecomfe/echarts/blob/master/doc/asset/img/dataRange.gif)
...
![ECharts 数据区域选择](https://github.com/ecomfe/echarts/blob/master/doc/asset/img/effect.gif)
...
![ECharts 数据区域选择](https://github.com/ecomfe/echarts/blob/master/doc/asset/img/scatter.gif)

### 动态数据添加
如果你需要展示有实时变化的数据，相信这个动态接口会对你很有帮助。

![ECharts 标线辅助](https://github.com/ecomfe/echarts/blob/master/doc/asset/img/dynamic1.gif)
...
![ECharts 标线辅助](https://github.com/ecomfe/echarts/blob/master/doc/asset/img/mark.gif)

### 多维度堆积
支持多系列，多维度的数据堆积，配合自动伸缩的图形实体和直角坐标系，能呈现出更有内涵的统计图表~

![ECharts 多维度堆积](https://github.com/ecomfe/echarts/blob/master/doc/asset/img/multiStack.png)

### 子区域地图模式
地图类型支持world，china及全国34个省市自治区。同时支持子区域模式，通过主地图类型扩展出所包含的子区域地图，轻易输出全球176个国家地区和全国600多个省市区域简图。

![ECharts 个性化定制](https://github.com/ecomfe/echarts/blob/master/doc/asset/img/subMapType.png)

### GeoJson地图扩展
内置地图由标准GeoJson地理数据并经过高效的压缩算法压缩生成的地图数据（大小仅为标准geoJson的30%左右）驱动而来。如果内置地图类型或数据如果并未满足你的项目需要，可通过简单动态注册产生你所需要的新类型。

![ECharts 个性化定制](https://github.com/ecomfe/echarts/blob/master/doc/asset/img/example/map7.png)

### 个性化定制
500+个可配置选项结合多级控制设计满足高度定制的个性化需求。

![ECharts 个性化定制](https://github.com/ecomfe/echarts/blob/master/doc/asset/img/custom.png)

### 事件交互
可以捕获的用户交互和数据变化事件实现图表与外界的联动。<a href="doc/example/event.html" target="_blank">try this &raquo;</a>

![ECharts 个性化定制](https://github.com/ecomfe/echarts/blob/master/doc/asset/img/example/mix3.png)